...
function genSharedStyle() {
  return [
    ...
    '.post-item{padding:16px 0;border-bottom:1px solid var(--border-color);transition:background 0.2s;padding-left:12px;border-left:3px solid transparent}',
    '.post-item:hover{background:var(--hover-bg);border-left:3px solid var(--primary-color)}',
    '.post-item:last-child{border-bottom:none}',
    '.post-item-inner{display:flex;gap:14px;align-items:center}',
    '.post-thumb-link{flex-shrink:0;width:80px;height:80px;overflow:hidden;border-radius:8px;display:block}',
    '.post-thumb{width:80px;height:80px;object-fit:cover;border-radius:8px;display:block}',
